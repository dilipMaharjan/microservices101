package com.dmaharjan.currencycalculationservice;
...
import com.dmaharjan.currencycalculationservice.bean.CurrencyConversionBean;
...
public class CurrencyCalculationController {
	...
	@GetMapping("/currency-converter/{from}/to/{to}/{quantity}")
	...
	@GetMapping("/currency-converter-feign/{from}/to/{to}/{quantity}")
